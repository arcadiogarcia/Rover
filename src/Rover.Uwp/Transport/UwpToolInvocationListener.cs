    ...
    internal sealed class UwpToolInvocationListener : IDisposable
    {
        ...
        public async Task StartAsync()
        {
            ...
            try
            {
                ...
                System.Diagnostics.Debug.WriteLine($"[Rover.Uwp] ✅ Tool invocation listener STARTED on port {_port}");
            ...
            catch (Exception ex)
            {
                ...
                System.Diagnostics.Debug.WriteLine($"[Rover.Uwp] ❌ ERROR starting listener: {ex.Message}");
            ...
            StreamSocketListenerConnectionReceivedEventArgs args)
        {
            ...
            catch (Exception ex)
            {
                ...
                System.Diagnostics.Debug.WriteLine($"[Rover.Uwp] IPC connection error: {ex.Message}");
        ...
        private async Task HandleToolInvocationAsync(Stream outputStream, byte[] bodyBytes)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[Rover.Uwp] Tool invocation error: {ex}");
